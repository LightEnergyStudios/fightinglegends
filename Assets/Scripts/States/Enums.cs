...
namespace FightingLegends
{
	...
	public enum Move
	{
		...
		Strike_Medium = 3,		// tap
		Strike_Heavy = 4,		// tap
		Strike_Combo = 5,		// dumb AI - no longer used
		Block = 6,				// while held
	...
	public enum State
	{
		...
		Block_Idle_Damaged = 35500,		// skeletron only
...
//		Void = 100
	...
	public enum InfoBubbleMessage
	{
		None = (1 << 0),
		RedLight = (1 << 1),
		YellowLightProactive = (1 << 2),
		YellowLightReactive = (1 << 3),
		GreenLight = (1 << 4),
		FlashingGreenLight = (1 << 5),
		LeftArrow = (1 << 6),
		RightArrow = (1 << 7),
		Tap = (1 << 8),
		SwipeLeft = (1 << 9),
